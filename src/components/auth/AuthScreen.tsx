/**
 * @fileoverview Tela de autenticação com login social e email
 */
    ...
    <div className="min-h-[100dvh] bg-gradient-to-br from-background via-background to-primary/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-primary/20">
        <CardHeader className="text-center space-y-4">
          ...
          <CardTitle className="text-2xl">VibePlayer</CardTitle>
          <CardDescription>
            Entre para começar seu trial gratuito de 24 horas
          </CardDescription>
        </CardHeader>
